...
class Homography:
    ...
    def check_object_isout(self, image_shape, deteced_objects, predicted_homography):   
        ...
        for index, objectDetected in enumerate(deteced_objects):
            ...
            try:
                ...
                dst = None
            if dst is not None and (not np.isnan(dst[0]) or not np.isnan(dst[1])):
    ...
    def generate_pitch(self, image_shape, deteced_objects, predicted_homography, pitch_2D_width = 320, pitch_2D_height = 180, template_path = 'narya/world_cup_template.png'):
